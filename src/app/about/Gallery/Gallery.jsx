...
const Gallery = () => {
  return (
    <div className="w-full bg-gray-900 p-6">
      <h1 className="text-4xl font-bold text-center text-white mb-8">Web Development Portfolio</h1>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <section className="p-8 bg-gray-800 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-white mb-4">Project 1</h2>
          <img src="path/to/image1.jpg" alt="Project 1" className="w-full h-64 object-cover rounded-lg mb-4" />
        ...
        <section className="p-8 bg-gray-800 rounded-lg shadow-md">
          ...
          <img src="path/to/image2.jpg" alt="Project 2" className="w-full h-64 object-cover rounded-lg mb-4" />
        ...
        <section className="p-8 bg-gray-800 rounded-lg shadow-md">
          ...
          <img src="path/to/image3.jpg" alt="Project 3" className="w-full h-64 object-cover rounded-lg mb-4" />
        ...
        <section className="p-8 bg-gray-800 rounded-lg shadow-md">
          ...
          <img src="path/to/image4.jpg" alt="Project 4" className="w-full h-64 object-cover rounded-lg mb-4" />
