    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 text-white py-24">
        <div className="container mx-auto text-center">
          ...
          <Link href="/" className="inline-block bg-gray-700 text-white hover:text-gray-700 hover:bg-white py-4 px-8 rounded-full text-lg font-semibold transition duration-300">
            Explore My Projects
          </Link>
        </div>
      </div>
